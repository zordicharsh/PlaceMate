      ...
      <div className="w-full max-w-5xl bg-[#13131a] rounded-3xl overflow-hidden shadow-2xl border border-white/5 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16">
          <div className="w-full max-w-md">
            ...
            {/* Role Toggle */}
            <div className="flex w-full bg-[#1c1c24] rounded-xl p-1 mb-6 border border-white/5">
              <button
                type="button"
                onClick={() => setRole("jobseeker")}
                className={`w-1/2 py-2.5 rounded-lg font-semibold transition-all duration-300 cursor-pointer ${
                  role === "jobseeker"
            ...
            <form key={role} className="space-y-5" onSubmit={handleSubmit}>
